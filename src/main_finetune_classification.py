...
def worker(rank, world_size, 
    ...
    train_files, val_test_files = train_test_split(cif_files, test_size=0.4, random_state=42)
    ...
    trainer = TrainerFineTuneClassification(
        model.to(rank), 
        path=modelsave_path,
        parallel=True,
...
if __name__=="__main__":
    ...
    parser.add_argument("--attr_func", type=str, default='int', help="A function applied to the output quantity.")
