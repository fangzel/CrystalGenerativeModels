...
class TrainerFineTuneClassification:
    ...
    def configure_optimizer(self,):
        ...
        self.optimizer = torch.optim.Adam(self.model.output_block.parameters(), lr=1e-4)
    ...
    def train_epoch(self, train_loader):
        ...
        for batch in pbar:
            ...
            # loss
            loss = self.criterion(torch.nn.LogSoftmax(dim=-1)(prediction.squeeze(1)),\
                                  expectation)
            loss.backward()
            self.optimizer.step()
    ...
    def load_from_checkpoint(self, path):
        ...
        #     param.requires_grad = loaded_dict['requires_grad_info'][name]
        ...
        if isinstance(self.model, torch.nn.parallel.DistributedDataParallel):
            ...
            self.optimizer = torch.optim.Adam(self.model.module.output_block.parameters(), lr=1e-4)
        else:
